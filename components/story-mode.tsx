...
const STORY_SCRIPT =
  "Meet Aditya Pratap Singh Tomar — a data scientist, software engineer, and MLOps builder. He ships production-ready systems with clear metrics, clean architecture, and practical deployment. His flagship work includes ForesightX for stock forecasting and Deep ECG Signal Analysis for transformer-based biomedical classification. You will also see BinSavvy and MargDarshak-Mitr, showing hands-on computer vision and product engineering experience. His internships and lead engineering role reflect ownership from prototype to delivery. Key strengths: ML system design, data science workflows, backend APIs, and MLOps reliability. If you're hiring for software engineering, data science, or ML engineering, this portfolio shows real execution and measurable outcomes."
