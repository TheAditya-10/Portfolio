    ...
    <section id="faq" className="py-24">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-10 lg:grid-cols-[0.75fr_1.25fr]">
          <div>
            <p className="text-xs font-mono uppercase tracking-[0.3em] text-muted-foreground">FAQ</p>
            <h2 className="mt-3 text-3xl font-semibold text-foreground md:text-4xl">
              Questions clients usually ask first.
            </h2>
            <p className="mt-4 text-muted-foreground">
              Send an enquiry with your service type, phone number, and email. You will receive
              a confirmation automatically.
            </p>
            <Link
              href="#enquiry"
